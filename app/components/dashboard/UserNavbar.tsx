    ...
    <header className="sticky top-0 z-30 border-b border-gray-200 bg-white/95 backdrop-blur">
      <div className="flex min-h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden min-w-[240px] max-w-md flex-1 items-center rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-gray-500 lg:flex">
          ...
          <input
            type="search"
            placeholder="Search bookings, invoices, plumbers"
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            {isMenuOpen && (
              <div className="absolute right-0 mt-2 w-64 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-xl">
