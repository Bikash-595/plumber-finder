...
//   const handleBooking = () => {
//     alert(`Booking request sent to ${plumber.companyName}! They will contact you shortly.`);
//   };

//   return (
//     <div className="sticky top-8 rounded-2xl bg-white p-6 shadow-lg border border-gray-200">
...
//               className="w-full rounded-full border border-gray-300 pl-10 pr-4 py-2 appearance-none"
//             >
...
//           className="w-full rounded-full bg-[#FFD60A] py-3 font-semibold text-white transition hover:brightness-105"
//         >
//           Request Booking
//         </button>
//         <p className="text-center text-xs text-gray-500">No commitment. Free estimate.</p>
//       </div>
//     </div>
//   );
// }
